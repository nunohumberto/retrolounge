    ...
    (function($) {
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                 ...
                 */
                self.root = $('<div></div>');
                self.screen = $('<canvas class="nes-screen" width="256" height="240" style="width: 30vw; height: 30vw;"></canvas>').appendTo(self.root);
                ...
                self.romContainer = $('<div style="display:none" class="nes-roms"></div>').appendTo(self.root);
                self.romSelect = $('<select style="display:none"></select>').appendTo(self.romContainer);
                
                self.controls = $('<div style="display:none" class="nes-controls"></div>').appendTo(self.root);
                self.buttons = {
