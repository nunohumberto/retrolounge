<%@ Page Title="Playing" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="playGB.aspx.cs" Inherits="EDCFinal.playGB" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <h3><i class="fa fa-gamepad"></i>&nbsp;&nbsp;Playing Classic GameBoy</h3>
    <hr />
        <div id="GameBoy" class="window">
            ...
            <center>
                <div id="gfx">
                 ...
                 <br />
        <img src="/Content/gbctr.png" style="width: 400px" />
            </center>
        </div>
